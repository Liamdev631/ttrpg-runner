...
from cyberpunk_lib import format_json
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Roll dice for cyberpunk-runner.")
    ...
    red = subparsers.add_parser("red-check", help="Roll a fast cyberpunk-style 1d10 + stat + skill + modifier check.")
